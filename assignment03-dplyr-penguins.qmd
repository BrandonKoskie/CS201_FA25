...
```{r, message=FALSE, warning=FALSE}
final_boss <- penguins %>% 
#keep penguins with only known flipper length on Dream or Biscoe
  filter(
    sex == "FEMALE",
...
#categorize flipper lengths in short medium and long
mutate(
...
#group by species, island, and flipper_rank, and summarize the average body mass
